...
const ARABIC_SYSTEM_PROMPT =
  ...
  "Если глагол введён вместе с обязательным предлогом управления после него (например بِـ, لِـ, إِلَى, عَنْ, " +
  "مِنْ или عَلَى), не отбрасывай предлог: сохрани сочетание целиком в поле word в словарной форме, например " +
  "'اِهْتَمَّ بِـ'. Приставные بِـ и لِـ могут быть введены как отдельное 'بِ'/'لِ', с кашидой 'بِـ'/'لِـ' или " +
  "слитно со следующим словом — считай это одним и тем же управлением. В переводе учитывай именно это управление. " +
